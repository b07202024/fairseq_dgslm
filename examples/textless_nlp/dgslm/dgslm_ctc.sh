...
BIN_DATA_DIR=/home/yukuanfu88/iven/fairseq_dgslm/examples/textless_nlp/dgslm/16k_bin
CHECKPOINT_DIR=/work/yukuanfu88/dgslm_results/ctc
...
CUDA_VISIBLE_DEVICE='0,1,2,3,4,5,6,7' fairseq-train $BIN_DATA_DIR \
    ...
    --unit-channels unitA,unitB --text-channels textA,textB --frame-channels timeA,timeB \
