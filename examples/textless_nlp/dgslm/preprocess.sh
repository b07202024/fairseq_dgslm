RAW_DATA_DIR=/home/iven/fairseq/examples/textless_nlp/data   # path to text and unit file generated from unit_generate.sh
BIN_DATA_DIR=/home/iven/fairseq/examples/textless_nlp/data   # path to put the binary results
...
for channel in "unitA" "unitB" "textA" "textB"; do
