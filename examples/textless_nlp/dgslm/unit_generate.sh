...
for splt in "train" "valid" "test"; do
    MANIFEST_FILE="/home/yukuanfu88/iven/fairseq_dgslm/examples/wav2vec/fisher_sliced/$splt.tsv"
    OUTPUT_FILE="/home/yukuanfu88/iven/fairseq_dgslm/examples/textless_nlp/2000hr/$splt"
